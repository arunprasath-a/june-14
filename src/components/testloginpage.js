...
import { onNameChange, onPassChange, receiveGridData} from "../store/actions/actions";
import { FaUserTie } from "react-icons/fa";
import "../css/signuppage.css";



class TestLogInPageComponent extends React.Component {
                        ...
                        <Col xs="6"><div className="loginform">
                            <form onSubmit={this.onFormSubmit.bind(this)}>
                                ...
                                <div className="loginElements">
                                    ...
                                    <div>
                                        <Button color="primary" onClick ={this.props.receiveGridData}>Log In</Button>
                                    </div>
...
const mapDispatchToProps = (dispatch) => {
    return bindActionCreators({
        ...
        receiveGridData: receiveGridData
       }, dispatch)
}



export default connect(mapStateToProps, mapDispatchToProps)(TestLogInPageComponent); 